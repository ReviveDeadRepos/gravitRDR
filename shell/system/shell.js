(function (_) {
  ...
  /** @override */
  GSystemShell.prototype.addMenuItem = function (
    parentMenu,
    title,
    checkable,
    shortcut,
  ...
  /** @override */
  GSystemShell.prototype.updateMenuItem = function (
    item,
    title,
    enabled,
    checked,
      ...
      if (typeof key == "number") {
        ...
        switch (key) {
          ...
          case IFKey.Constant.CONTROL:
            result.modifiers =
              result.modifiers + (result.modifiers ? "-" : "") + "ctrl";
            break;
          case IFKey.Constant.SHIFT:
            result.modifiers =
              result.modifiers + (result.modifiers ? "-" : "") + "shift";
            break;
          case IFKey.Constant.ALT:
            result.modifiers =
              result.modifiers + (result.modifiers ? "-" : "") + "alt";
            break;
          case IFKey.Constant.COMMAND:
            result.modifiers =
              result.modifiers + (result.modifiers ? "-" : "") + "cmd";
            break;
