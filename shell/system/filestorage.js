(function (_) {
  ...
  GFileStorage.prototype.openResourcePrompt = function (
    ...
    this._fileInput.attr("accept", filter ? filter : "").trigger("click");
  };
  ...
  GFileStorage.prototype.saveResourcePrompt = function (
    ...
    this._fileInput
      ...
      .attr(
        "nwsaveas",
        proposedName ? proposedName + (extension ? "." + extension : "") : "",
      )
  ...
  GFileStorage.prototype.openDirectoryPrompt = function (reference, done) {
    ...
    this._fileInputCallback = done;
    this._prepareInput(reference);
    this._fileInput.attr("nwdirectory", "").trigger("click");
  };
  ...
  GFileStorage.prototype._prepareInput = function (reference) {
    ...
    if (workingDir && workingDir !== "") {
      this._fileInput.attr("nwworkingdir", workingDir);
    } else {
      this._fileInput.removeAttr("nwworkingdir");
    }
  };
