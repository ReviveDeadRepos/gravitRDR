...
import { GShell, GMenu, GMenuBar, GMenuItem } from "@gravitrdr/application";
...
GBrowserShell.prototype.prepare = function () {
  ...
  menuElement.css("height", "100%").prependTo($("#header"));
};
...
/** @override */
GBrowserShell.prototype.addMenuItem = function (
  parentMenu,
  title,
  checkable,
  shortcut,
...
/** @override */
GBrowserShell.prototype.updateMenuItem = function (
  item,
  title,
  enabled,
  checked,
