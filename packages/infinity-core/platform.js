...
import { ifSystem, IFSystem } from "./core/system";
/**
 ...
 * @private
 */
GUIPlatform.prototype._modifiersChangedEventCache =
  new GUIPlatform.ModifiersChangedEvent();
...
GUIPlatform.prototype._updateModifiers = function (event) {
  ...
  var _evMetaKey =
    ifSystem.operatingSystem !== IFSystem.OperatingSystem.OSX_IOS ||
...
export var ifPlatform = new GUIPlatform();
