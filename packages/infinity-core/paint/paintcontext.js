import { IFPaintConfiguration } from "./paintconfiguration";
import { IFPaintCanvas } from "./paintcanvas";
import { IFDirtyList } from "./dirtylist";
 ...
 * @constructor
 */
export function IFPaintContext() {
  this.outlineColors = [];
}
