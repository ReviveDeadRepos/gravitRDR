 ...
 */
IFFont.prototype.getGlyphOutline = function (
  family,
  variant,
  size,
  x,
  ...
  return new IFVertexTransformer(
    outline,
    new IFTransform(scale, 0, 0, scale, x, y),
  );
};

export var ifFont = new IFFont();
