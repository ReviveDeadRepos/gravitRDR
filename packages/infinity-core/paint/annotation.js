import { IFPaintContext } from "./paintcontext";
 ...
 */
IFAnnotation.prototype.paintAnnotation = function (
  context,
  transform,
  center,
  annotation,
  ...
  var vertices = new IFVertexTransformer(
    annotationTemplate.vertices,
    new IFTransform(sx, 0, 0, sy, cx, cy),
  );
...
export var ifAnnotation = new IFAnnotation();
