...
IFDirtyList.prototype.dirty = function (x, y, w, h) {
  ...
  if (this._area) {
    ...
    if (x + w > this._area.getX() + this._area.getWidth())
      w = this._area.getX() + this._area.getWidth() - x;
    if (y + h > this._area.getY() + this._area.getHeight())
      h = this._area.getY() + this._area.getHeight() - y;
  }
  ...
  for (var i = 0; i < this._numDirties; i++) {
    ...
    if (
      ...
      this._dirties[i][1] >= y &&
      this._dirties[i][1] + this._dirties[i][3] <= y + h
    ) {
      ...
      this._dirties[i][0] + this._dirties[i][2] > x &&
      this._dirties[i][0] + this._dirties[i][2] <= x + w &&
      this._dirties[i][1] >= y &&
      this._dirties[i][1] + this._dirties[i][3] <= y + h
    ) {
      ...
      this._dirties[i][0] >= x &&
      this._dirties[i][0] + this._dirties[i][2] <= x + w &&
      this._dirties[i][1] + this._dirties[i][3] > y &&
      this._dirties[i][1] + this._dirties[i][3] <= y + h
    ) {
