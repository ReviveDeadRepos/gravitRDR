...
import { IFColorSpace } from "../paint/colorspace";
...
IFNode.inheritAndMix("scene", IFScene, IFElement, [
  IFNode.Container,
  IFNode.Properties,
  IFNode.Store,
  GEventTarget,
...
IFNode.inheritAndMix("styleCollection", IFScene.StyleCollection, IFNode, [
  IFNode.Container,
  IFNode.Store,
]);

/** @override */
IFScene.StyleCollection.prototype.validateInsertion = function (
  parent,
  reference,
) {
...
IFNode.inheritAndMix("swatchCollection", IFScene.SwatchCollection, IFNode, [
  IFNode.Container,
  IFNode.Store,
]);

/** @override */
IFScene.SwatchCollection.prototype.validateInsertion = function (
  parent,
  reference,
) {
  return parent instanceof IFScene;
  ...
  this.acceptChildren(function (node) {
    if (node instanceof IFElement) {
      ...
      if (paintBBox && !paintBBox.isEmpty()) {
        if (
          (inside && rect.intersectsRect(paintBBox)) ||
...
IFScene.prototype.willPageIntersectWithOthers = function (page, pageRect) {
  pageRect = pageRect.expanded(
    IFScene.PAGE_SPACING,
    IFScene.PAGE_SPACING,
    IFScene.PAGE_SPACING,
    IFScene.PAGE_SPACING,
  );
...
/** @override */
IFScene.prototype.hitTest = function (
  location,
  transform,
  acceptor,
  stacked,
  ...
  return IFElement.prototype.hitTest.call(
    this,
    location,
    transform,
    acceptor,
