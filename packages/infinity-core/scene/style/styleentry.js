 ...
 * @private
 */
IFStyleEntry.prototype._handleGeometryChangeForProperties = function (
  change,
  args,
  properties,
) {
 ...
 * @private
 */
IFStyleEntry.prototype._handleVisualChangeForProperties = function (
  change,
  args,
  properties,
) {
