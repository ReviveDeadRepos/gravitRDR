...
GUIMouseEvent.isDragEvent = function (event) {
  return (
    (event instanceof GUIMouseEvent &&
      (event instanceof GUIMouseEvent.DragStart ||
        event instanceof GUIMouseEvent.Drag ||
        event instanceof GUIMouseEvent.DragEnd)) ||
    event == GUIMouseEvent.DragStart ||
    event == GUIMouseEvent.Drag ||
    event == GUIMouseEvent.DragEnd
  );
};
...
GUIMouseEvent.prototype._paramsToString = function () {
  return (
    ...
    ", " +
    GUIInputEvent.prototype._paramsToString.call(this)
  );
};
