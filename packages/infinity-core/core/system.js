...
export function IFSystem() {
  ...
  this.hardware = (function () {
    ...
    var phone = !!navigator.userAgent.match(
    ...
    var os_data = [
      {
        ...
        subString: "Win",
        identity: IFSystem.OperatingSystem.Windows,
      },
      {
        string: navigator.platform,
        subString: "Mac",
        identity: IFSystem.OperatingSystem.OSX_IOS,
      },
      {
      ...
      },
      {
        string: navigator.userAgent,
        subString: "Android",
        identity: IFSystem.OperatingSystem.Unix,
      },
      {
        string: navigator.platform,
        subString: "Linux",
...
export var ifSystem = new IFSystem();
