...
import { ifVertexInfo } from "@gravitrdr/infinity-core";
 ...
 * @constructor
 */
export function IFMarqueeTool(areaSelector) {
  IFTool.call(this);
...
IFMarqueeTool.prototype._mouseDragEnd = function (event) {
  if (this._areaBounds) {
    ...
    var collisionArea = new IFVertexTransformer(
      this._areaSelector._pixelTransformer,
