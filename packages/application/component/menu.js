import { GMenuItem } from "./menuitem";
...
GMenu.setActiveMenu = function (menu, noCloseCall) {
  ...
  if (this._activeMenu) {
    ...
    document.removeEventListener(
      "mousemove",
      GMenu._activeMenuMouseMoveListener,
    );
    document.removeEventListener(
      "mousedown",
      GMenu._activeMenuMouseUpDownListener,
    );
    document.removeEventListener(
      "mouseup",
      GMenu._activeMenuMouseUpDownListener,
 ...
 * @returns {GMenuItem}
 */
GMenu.prototype.createInsertItem = function (
  index,
  caption,
  activate,
  enter,
...
GMenu.prototype.open = function (reference, horzPosition, vertPosition) {
  horzPosition =
    typeof horzPosition === "number" ? horzPosition : GMenu.Position.Center;
  vertPosition =
    typeof vertPosition === "number" ? vertPosition : GMenu.Position.Center;
