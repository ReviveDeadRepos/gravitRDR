...
import { IFEditorView } from "@gravitrdr/infinity-editor";
import { IFPoint } from "@gravitrdr/infinity-core";
import { IFObject } from "@gravitrdr/infinity-core";
import { GDocument } from "../document";
import { GMenu } from "../component/menu";
import { GMenuItem } from "../component/menuitem";
 ...
 * @version 1.0
 */
export function GWindow(document) {
...
GWindow.prototype._createContextMenu = function () {
  ...
  selectItem.addEventListener(
    ...
    function () {
      ...
      var elementHits = this._document.getScene().hitTest(
        ...
        true,
        -1,
        this._document.getScene().getProperty("pickDist"),
        true,
      );
      ...
      if (elementHits && elementHits.length > 0) {
        ...
        for (var i = 0; i < elementHits.length; ++i) {
          ...
          var name =
            element instanceof IFBlock
              ? element.getLabel()
              : element.getNodeNameTranslated();
          ...
          selectItem.getMenu().createAddItem(
            ...
            function () {
              ...
              self._document
                .getEditor()
                .updateSelection(ifPlatform.modifiers.shiftKey, [this.element]);
            },
            function () {
