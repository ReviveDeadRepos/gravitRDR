import { GAreaPaintEntry } from "./areapaintentry";
 ...
 * @constructor
 */
export function GStrokePaintEntry() {
...
GStrokePaintEntry.prototype.createContent = function (scene, assign, revert) {
  var content = GAreaPaintEntry.prototype.createContent.call(
    this,
    scene,
    assign,
    revert,
        ...
        .append(
          $("<button></button>")
            ...
            .on("click", function (evt) {
              ...
              $this
                .closest(".g-form")
                .find('[data-element="stroke-settings"]')
...
/** @override */
GStrokePaintEntry.prototype.updateProperties = function (
  content,
  entry,
  scene,
) {
  ...
  content
    .find('[data-property="sw"]')
    .val(scene.pointToString(entry.getProperty("sw")));
  ...
  content
    .find('[data-property="slm"]')
    .val(scene.pointToString(entry.getProperty("slm")));
};

/** @override */
GStrokePaintEntry.prototype._getPropertiesToAssign = function (
  content,
  entry,
  scene,
  properties,
  ...
  GAreaPaintEntry.prototype._getPropertiesToAssign.call(
    this,
    content,
    entry,
    scene,
  ...
  properties.push("sw", "sa", "slc", "slj", "slm");
