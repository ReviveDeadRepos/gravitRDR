...
import { IFShadowEffect } from "@gravitrdr/infinity-core";
 ...
 * @constructor
 */
export function GShadowEffectEntry() {}
      ...
      $("<div></div>")
        ...
        .append(
          $("<div></div>")
            ...
            .append($("<label></label>").text("Color")),
        ),
    );
};

/** @override */
GShadowEffectEntry.prototype.updateProperties = function (
  content,
  entry,
  scene,
) {
  ...
  content
    ...
    .val(scene.pointToString(entry.getProperty("x")));
  content
    .find('[data-property="y"]')
    .val(scene.pointToString(entry.getProperty("y")));
  content
    .find('[data-property="r"]')
    .val(scene.pointToString(entry.getProperty("r")));
  content
    .find('[data-property="cls"]')
    .gColorButton("value", entry.getProperty("cls"));
};

/** @override */
GShadowEffectEntry.prototype.assignProperties = function (
  content,
  entry,
  scene,
) {
