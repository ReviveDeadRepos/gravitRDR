...
import { IFOffsetVEffect } from "@gravitrdr/infinity-core";
 ...
 * @constructor
 */
export function GOffsetVEffectEntry() {}
            ...
            .append(
              $("<input>")
                ...
                .on("input", function (evt) {
                  ...
                  $this
                    .parents(".g-form")
                    .find('[data-property="r"]:not([type="range"])')
                    .val($this.val());
                  assign();
                }),
            ),
...
/** @override */
GOffsetVEffectEntry.prototype.updateProperties = function (
  content,
  entry,
  scene,
) {
...
/** @override */
GOffsetVEffectEntry.prototype.assignProperties = function (
  content,
  entry,
  scene,
) {
  entry.setProperties(
    ...
    [
      scene.stringToPoint(
        content.find('[data-property="r"]:not([type="range"])').val(),
      ),
