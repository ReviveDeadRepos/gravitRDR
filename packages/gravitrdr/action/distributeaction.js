 ...
 * @constructor
 */
export function GDistributeAction(type) {
  this._type = type;
 ...
 * @override
 */
GDistributeAction.prototype.isEnabled = function (
  elements,
  geometry,
  referenceBox,
  spacing,
 ...
 * @override
 */
GDistributeAction.prototype.execute = function (
  elements,
  geometry,
  referenceBox,
  spacing,
  ...
  if (this._type === GDistributeAction.Type.Horizontal) {
    ...
    if (!spacing) {
      ...
      spacing =
        (referenceBox.getWidth() - elementsTotal) / (elements.length - 1);
    }
    ...
    if (!spacing) {
      ...
      spacing =
        (referenceBox.getHeight() - elementsTotal) / (elements.length - 1);
    }
