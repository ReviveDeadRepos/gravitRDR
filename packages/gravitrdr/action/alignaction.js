 ...
 * @constructor
 */
export function GAlignAction(type) {
  this._type = type;
 ...
 * @override
 */
GAlignAction.prototype.isEnabled = function (
  elements,
  compound,
  geometry,
  referenceBox,
 ...
 * @override
 */
GAlignAction.prototype.execute = function (
  elements,
  compound,
  geometry,
  referenceBox,
            ...
            if (center !== bbox.getX() + bbox.getWidth() / 2) {
              element.transform(
                new IFTransform(
                  ...
                  0,
                  1,
                  center - bbox.getX() - bbox.getWidth() / 2,
                  0,
                ),
              );
            }
            ...
            if (center !== bbox.getY() + bbox.getHeight() / 2) {
              element.transform(
                new IFTransform(
                  ...
                  1,
                  0,
                  center - bbox.getY() - bbox.getHeight() / 2,
                ),
              );
            }
            break;
            ...
            if (bottom !== bbox.getY() + bbox.getHeight()) {
              element.transform(
                new IFTransform(
                  ...
                  1,
                  0,
                  bottom - bbox.getHeight() - bbox.getY(),
                ),
              );
            }
            break;
