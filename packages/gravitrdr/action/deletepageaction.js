 ...
 * @constructor
 */
export function GDeletePageAction() {}
...
GDeletePageAction.prototype.isEnabled = function (page) {
  if (!page) {
    page = gApp.getActiveDocument()
      ? gApp.getActiveDocument().getScene().getActivePage()
      : null;
  }
...
GDeletePageAction.prototype.execute = function (page) {
  ...
  if (!otherPage) {
    // TODO : I18N
    alert(
      "Unable to delete - the document needs to contain at least one page.",
    );
    return;
  }
