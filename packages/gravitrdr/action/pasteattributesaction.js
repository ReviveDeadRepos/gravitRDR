...
GPasteAttributesAction.prototype.execute = function () {
  var attributes = IFNode.deserialize(
    window.window.gShell.getClipboardContent(IFAttribute.MIME_TYPE),
  );
  if (attributes) {
