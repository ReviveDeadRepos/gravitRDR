import { GTransformer } from "@gravitrdr/application";
 ...
 * @constructor
 */
export function GAlignTransformer() {
  this._elements = [];
}
 ...
 * @private
 */
GAlignTransformer.prototype._savedAlignTo =
  GAlignTransformer._AlignTo.Selection;
...
GAlignTransformer.prototype.init = function (panel) {
      ...
      $("<div></div>")
        ...
        .append(
          $("<button></button>")
            ...
            .append($("<span></span>").addClass("fa fa-align-left")),
        )
        .append(
          $("<button></button>")
            // TODO : I18N
            ...
            .append($("<span></span>").addClass("fa fa-align-center")),
        )
        .append(
          $("<button></button>")
            // TODO : I18N
            ...
            .append($("<span></span>").addClass("fa fa-align-right")),
        )
        .append(
          $("<button></button>")
            // TODO : I18N
            ...
            .append(
              $("<span></span>").addClass("fa fa-align-justify fa-rotate-270"),
            ),
        )
        .append(
          $("<button></button>")
            ...
            .append($("<span></span>").addClass("fa fa-reorder fa-rotate-270")),
        )
        .append(
          $("<input>")
            // TODO : I18N
      ...
      $("<div></div>")
        ...
        .append(
          $("<button></button>")
            ...
            .append(
              $("<span></span>").addClass("fa fa-align-right fa-rotate-270"),
            ),
        )
        .append(
          $("<button></button>")
            ...
            .append(
              $("<span></span>").addClass("fa fa-align-center fa-rotate-270"),
            ),
        )
        .append(
          $("<button></button>")
            ...
            .append(
              $("<span></span>").addClass("fa fa-align-left fa-rotate-270"),
            ),
        )
        .append(
          $("<button></button>")
            ...
            .append($("<span></span>").addClass("fa fa-align-justify")),
        )
        .append(
          $("<button></button>")
            .css("margin-left", "10px")
            ...
            .append($("<span></span>").addClass("fa fa-reorder")),
        )
        .append(
          $("<input>")
            // TODO : I18N
  ...
  var alignHandler = function (evt) {
    this._executeAction(
      $(evt.target).closest("button").attr("data-align"),
      "align",
    );
  }.bind(this);
  ...
  var distHandler = function (evt) {
    this._executeAction(
      $(evt.target).closest("button").attr("data-dist"),
      "dist",
    );
  }.bind(this);
...
GAlignTransformer.prototype.update = function (document, elements) {
  ...
  if (this._elements && this._elements.length === 1) {
    this._panel
      .find('select[data-option="align-to"]')
      .val(GAlignTransformer._AlignTo.Page);
  } else {
...
GAlignTransformer.prototype._getActionArgs = function (type, mode) {
  ...
  if (elements.length > 0) {
    var geometry = this._panel
      .find("input[data-align-geometry]")
      .is(":checked");

    if (mode === "align") {
      var compound =
        alignTo !== GAlignTransformer._AlignTo.Selection
          ? this._panel.find("input[data-align-selection]").is(":checked")
          : false;
      return {
      ...
      var spacing =
        scene.stringToPoint(
          this._panel.find('input[data-dist="' + type + '"]').val(),
        ) || 0;
      return {
...
GAlignTransformer.prototype._updateStates = function () {
  ...
  this._panel
    .find("input[data-align-selection]")
    .prop("disabled", !compoundCtrls);

  this._panel.find("[data-align]").each(
    function (index, element) {
      var $element = $(element);
      $element.prop(
        "disabled",
        !this._isActionEnabled($element.attr("data-align"), "align"),
      );
    }.bind(this),
  );
  ...
  this._panel.find("[data-dist]").each(
    function (index, element) {
      ...
      $element.prop(
        "disabled",
        !this._isActionEnabled($element.attr("data-dist"), "dist"),
      );
    }.bind(this),
  );
};
