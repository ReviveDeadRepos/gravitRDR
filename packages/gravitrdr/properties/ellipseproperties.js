 ...
 * @constructor
 */
export function GEllipseProperties() {
  this._ellipses = [];
}
  ...
  panel
    ...
    .append(
      $("<label></label>")
        ...
        .append(_createInput("etp").css("width", "114px")),
    )
    .append(
      $("<label></label>")
        .css({
...
GEllipseProperties.prototype._updateProperties = function () {
  ...
  this._panel
    .find('select[data-property="etp"]')
    .val(ellipse.getProperty("etp"));
  this._panel
    .find('input[data-property="sa"]')
    .val(
      ifUtil.formatNumber(
        ifMath.toDegrees(ifMath.PI2 - ellipse.getProperty("sa")),
        2,
      ),
    );
  this._panel
    ...
    .val(
      ifUtil.formatNumber(
        ifMath.toDegrees(ifMath.PI2 - ellipse.getProperty("ea")),
        2,
      ),
    );
};
