 ...
 * @constructor
 */
export function GRectangleProperties() {
  this._rectangles = [];
}
  ...
  var _createInput = function (property) {
    ...
    if (property === "uf") {
      ...
      return $("<button></button>")
        ...
        .append($("<span></span>").addClass("fa fa-lock fa-fw"));
    } else {
  ...
  panel
    ...
    .append(
      $("<label></label>")
        ...
        .append(_createInput("tl_ct").attr("title", titleUniform))
        .append(_createInput("tl_sx").attr("title", titleSmoothX))
        .append(_createInput("tr_sx").attr("title", titleSmoothX))
        .append(_createInput("tr_ct").attr("title", titleUniform)),
    )
    .append(
      $("<label></label>")
        .css({
        ...
        .append(_createInput("tl_sy").attr("title", titleSmoothY))
        .append(_createInput("tl_uf").attr("title", titleCornerType))
        .append(_createInput("tr_uf").attr("title", titleCornerType))
        .append(_createInput("tr_sy").attr("title", titleSmoothY)),
    )
    .append(
      $("<label></label>")
        .css({
        ...
        .append(_createInput("bl_sy").attr("title", titleSmoothY))
        .append(_createInput("bl_uf").attr("title", titleCornerType))
        .append(_createInput("br_uf").attr("title", titleCornerType))
        .append(_createInput("br_sy").attr("title", titleSmoothY)),
    )
    .append(
      $("<label></label>")
        .css({
        ...
        .append(_createInput("bl_ct").attr("title", titleUniform))
        .append(_createInput("bl_sx").attr("title", titleSmoothX))
        .append(_createInput("br_sx").attr("title", titleSmoothX))
        .append(_createInput("br_ct").attr("title", titleUniform)),
    );
};
    ...
    for (var i = 0; i < corners.length; ++i) {
      ...
      if (!hidden) {
        sx.val(
          this._document
            .getScene()
            .pointToString(rectangle.getProperty(corner + "_sx")),
        );
        sy.val(
          this._document
            .getScene()
            .pointToString(rectangle.getProperty(corner + "_sy")),
        );
 ...
 * @private
 */
GRectangleProperties.prototype._assignProperties = function (
  properties,
  values,
) {
